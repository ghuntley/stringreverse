...
namespace StringReverse.Tests
{
    ...
    public class StringReverseExtensionTests
    {
        ...
        {
            String value = null;
            value.Invoking(x => x.StringReverse()).ShouldThrow<NullReferenceException>();
        }

        [Test]
        public void StringEmpty()
        {
            String.Empty.StringReverse().Should().Be(String.Empty);
        }
        ...
        public void Two_Spaces()
        {
            ...
            input.StringReverse().Should().Be(expected);
        }
